...
let bulletExplotion = document.createElement("audio");
bulletExplotion.src = "sounds/explosion.wav";
bulletExplotion.setAttribute("controls", "none");
bulletExplotion.setAttribute("preload", "auto");
bulletExplotion.style.display = "none";
bulletExplotion.volume = 0.1;
container.append(bulletExplotion);

let soundGame = document.createElement("audio");
soundGame.src = "sounds/gamesound.mp3";
soundGame.setAttribute("controls", "none");
soundGame.setAttribute("preload", "auto");
soundGame.style.display = "none";
soundGame.volume = 0.1;
soundGame.loop = true;
container.append(soundGame);
